  ...
  translation: {
    ...
    model: {
      'claude-v5-sonnet': {
        ...
        description:
          'Model Sonnet paling mumpuni dari Anthropic dengan kecerdasan mendekati Opus, dirancang untuk pengkodean, agen, dan pekerjaan profesional dalam skala besar. Pemikiran adaptif selalu aktif.',
      },
      'claude-v3-haiku': {
